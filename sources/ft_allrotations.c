...
static void	ft_rotate_instructions(t_selem **stacka, t_selem **stackb, int len)
{
	int		i;
...
static void	ft_reverse_rotate_instructions(t_selem **stacka, \
t_selem **stackb, int len)
{
	int		i;
...
void		ft_countturns(t_selem **stacka, t_selem **stackb)
{
